 ...
 * @author Admin
 */
public class MAnalytics extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>Servlet MAnalytics</title>");

            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MAnalytics at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("Manalytics.jsp").forward(request, response);
        } catch (Exception e) {
